...
| 13626596 | dsv2 | icepop | 3 | m13h/gpu | `suite_dsv2_icepopvllm_s3` |
...
- **13621182(dsv2 icepop s3)已于 2026-09-10 11:19 取消并重提为 13626596**:原 job 在
  Epoch 2/3 Step 28/29 之后挂死(rollout_complete 回调 30s 超时 ×12 → session 全部 stale,
  日志静默 1h41m),checkpoint 只有 2/3 个 epoch,按静默失败处理。详见 NOTES_tianruny.md R1。
